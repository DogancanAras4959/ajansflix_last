...
{
    public class OrderStatusService : CrudService<OrderStatus, OrderStatusDto>, IOrderStatusService
    {
        public OrderStatusService(IRepository<OrderStatus> repository, IMapper mapper) : base(repository, mapper)
        {
